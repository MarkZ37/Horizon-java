...
//    Log log = LogFactory.getLog(OSSClientUtil.class);
    ...
    //阿里云OSS账号
    protected static String accessKeyId = "LTAI4G29LGtjPRK2wB2K8UUY";
    //阿里云OSS密钥
    protected static String accessKeySecret = "tygXgMVzoMxTX7nTiYGGBsCvHzDhRr";
    //阿里云OSS上的存储块bucket名字
    protected static String bucketName = "markhorizon";

    //阿里云图片文件存储目录
    private String homeimagedir = "article/img/";
